...
app.use((err, req, res, next) => {
  // userController was using error: {error: 'message'} instead of the defaultErr format,
  // so this line fixes those (at least for backend logging)
  if (err.error) err.log = err.error;
  const defaultErr = {
